...
public class Poissonprocess {
	...
	public static< T extends RealType< T > & NativeType< T >>  RandomAccessibleInterval< FloatType > poissonProcess( final RandomAccessibleInterval< FloatType > in, final float poissonSNR )
	{
